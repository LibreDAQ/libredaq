...
class circular_buffer
{
   ...
   public:
    ...
    /** Peeks at an element from the current read position of the buffer,
     * without checking if it is past the actual number of available elements.
     */
     ...
     * (this is NOT the maximum size of the internal buffer) \sa capacity
     */
    size_t size() const
    {
        if (m_next_write >= m_next_read)
