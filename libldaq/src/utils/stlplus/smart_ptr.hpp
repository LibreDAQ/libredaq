...
namespace stlplus
{
  ...
  template<typename T, typename C, typename COUNTER> // Typically: COUNTER = libredaq::synch::CAtomicCounter>
  ...
  template <typename T,typename COUNTER = libredaq::synch::CAtomicCounter>
