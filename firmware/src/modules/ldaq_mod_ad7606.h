...
#define DAQ_CONVST_GPIO      LDAQ_SLOT3_CTRL0_GPIO
#define DAQ_CONVST_PIO       LDAQ_SLOT3_CTRL0_PIO
#define DAQ_CONVST_IDX       LDAQ_SLOT3_CTRL0_IDX

#define DAQ_nRD_GPIO         LDAQ_SLOT3_CTRL1_GPIO
#define DAQ_nRD_PIO          LDAQ_SLOT3_CTRL1_PIO
#define DAQ_nRD_IDX          LDAQ_SLOT3_CTRL1_IDX

#define DAQ_BUSY_GPIO        LDAQ_SLOT3_CTRL2_GPIO
#define DAQ_BUSY_PIO         LDAQ_SLOT3_CTRL2_PIO
#define DAQ_BUSY_IDX         LDAQ_SLOT3_CTRL2_IDX
#define DAQ_BUSY_ID          LDAQ_SLOT3_CTRL2_ID
#define DAQ_BUSY_IRQn        LDAQ_SLOT3_CTRL2_IRQn

#define DAQ_1STDATA_GPIO     LDAQ_SLOT3_CTRL3_GPIO
